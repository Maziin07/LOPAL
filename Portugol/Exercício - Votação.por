...
programa
{
    ...
    cadeia candidato_b1
      ...
      escreva(" Qual é o candidato 1? \n")
      leia(candidato_a1)
      escreva(" Qual é o candidato 2? \n")
      leia(candidato_b1)
		...
		se (total_votos > 0)
		{
			...
			escreva(" Candidato 1:", candidato_a, " voto(s). ", porcentagem_candidato_a, " % do total\n" )
			escreva(" Candidato 2:", candidato_b, " voto(s). ", porcentagem_candidato_b, " % do total\n" )
